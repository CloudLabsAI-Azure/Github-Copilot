...
Trabalhar com o Copilot para aprendizagem automática implica aproveitar o GitHub Copilot, uma ferramenta de conclusão de código com tecnologia de IA desenvolvida pelo GitHub em colaboração com a OpenAI. Aqui está um rápido resumo das principais etapas e considerações:
...
Integração com o GitHub: ligue o seu IDE à sua conta GitHub para permitir uma integração perfeita. Isto permite que o Copilot aceda aos seus repositórios de código e forneça sugestões baseadas no contexto.
...
Neste exercício, irá clonar o repositório Git com o conjunto de dados necessário no seu ambiente. Aqui, irá trabalhar com o Copilot for Machine Learning, que envolve o aproveitamento do GitHub Copilot.
...
- Tarefa 3: Aprendizagem matemática e de máquina com diferentes exemplos
- Tarefa 4: Visualização e Transformação de Dados
- Tarefa 5: Treinar o modelo de amostra

### Tarefa 1: Pré-requisitos e injeção do conjunto de dados necessário no seu ambiente

1. Abra o Terminal do VS Code clicando em **Reticências (...)** **(1)**, seleccionando **Terminal** **(2)** e clicando em **Novo Terminal** **(3)**.
...
1. Na janela do VS Code Explorer, clique com o botão direito do rato na pasta denominada **ml-copilot-workshop** **(1)** e clique em **Novo ficheiro**. Nomeie o ficheiro `Experiments.ipynb` **(2)** e verifique se o seu novo ficheiro se parece com o que se mostra abaixo:
...
1. Aceite todas as sugestões para a importação de bibliotecas conforme imagem abaixo **(1)** e clique no botão **Executar** **(2)** para executar a célula. Clique em `+Código` **(3)** para adicionar a nova célula.
...
1. Clique agora em **+Código** e passe para a tarefa seguinte.


### Tarefa 3: Aprendizagem matemática e automática com diferentes exemplos

### Tarefa 3.1: Operações Matemáticas

1. Introduza os comentários abaixo para realizar a primeira experiência matemática que seria gerar o ano de nascimento a partir da coluna da idade presente no conjunto de dados. Prima “enter” para ir para a linha seguinte e rever a sugestão, e prima “tab” para aceitar a sugestão e clique no botão **Executar** para executar a célula.
   ...
   >**Nota**: Continue a clicar em **+Código** após cada comentário até à última tarefa deste exercício.
...
1. Clique em **+Código** para abrir a nova célula e introduza os comentários abaixo para realizar as operações básicas no conjunto de dados. Prima “enter” para ir para a linha seguinte e rever a sugestão, e prima “tab” para aceitar a sugestão e clique no botão **Executar** para executar a célula.
...
1. Clique em **+ Código** para adicionar uma nova célula e digite os comentários abaixo para criar o modelo de floresta aleatório. Prima “enter” para ir para a linha seguinte e rever a sugestão e prima “tab” para aceitar as sugestõese clique no botão **Executar**
