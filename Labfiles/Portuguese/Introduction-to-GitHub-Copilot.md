...
O GitHub Copilot é a primeira ferramenta de desenvolvimento de IA à escala do mundo que o pode ajudar a escrever código mais rapidamente e com menos trabalho. O GitHub Copilot utiliza comentários e contexto de código para sugerir instantaneamente linhas específicas de código e todas as funções.

A investigação descobriu que o GitHub Copilot ajuda os programadores a codificar mais rapidamente, a focar-se na resolução de problemas maiores, a permanecer no fluxo durante mais tempo e a sentir-se mais satisfeitos com o seu trabalho.

Desenvolvido por OpenAI Codex e GitHub O modelo de linguagem pré-treinado e generativo do Copilot foi criado pela OpenAI. Está disponível uma extensão para o Visual Studio Code, Visual Studio, Neovim e o conjunto JetBrains de ambientes de desenvolvimento integrados (IDEs).
...
Com o GitHub Copilot for Business, o GitHub Copilot está aberto a todos os programadores, equipas, organizações e empresas.

Focado em tornar as organizações mais produtivas, seguras e realizadas, o GitHub Copilot for Business permite aos programadores codificar mais rapidamente e concentrar-se num trabalho mais satisfatório.
...
Os proprietários da empresa podem permitir que algumas ou todas as organizações da empresa acedam ao GitHub Copilot. Se uma organização tiver acesso ao Copilot, os proprietários da organização poderão atribuir licenças do Copilot Enterprise a alguns ou a todos os membros da organização.
...
- **GitHub Copilot Chat em GitHub.com**: GitHub Copilot Chat em GitHub.com é uma interface de chat que eupermite-lhe perguntar e receber respostas a perguntas relacionadas com a codificação em GitHub.com.
- **Resumos de pull request do Copilot**: os resumos de pull request do Copilot são uma funcionalidade alimentada por IA que permite criar um resumo das alterações feitas a um pull request, que ficheiros impactam e em que é que um revisor se deve concentrar quando conduzem a sua revisão.
...
Utilizar o GitHub Copilot for Business na sua empresa: primeiro deve estabelecer uma política para utilizar o GitHub Copilot for Business na sua empresa. Assim que o GitHub Copilot for Business estiver ativado a nível empresarial, pode definir as definições do GitHub Copilot para cada organização da sua empresa.

### Activação do GitHub Copilot Enterprise

Para permitir que os utilizadores utilizem as funcionalidades do Copilot Enterprise, a sua empresa GitHub Enterprise Cloud deve ter uma subscrição do Copilot Enterprise.

O acesso ao Copilot é determinado nos níveis empresarial e organizacional:

- Os proprietários da empresa podem permitir que algumas ou todas as organizações da empresa acedam ao Copilot.
- Os proprietários de organizações que receberam acesso ao Copilot podem atribuir licenças do GitHub Copilot Enterprise a alguns ou a todos os membros da sua organização.
...
- Os proprietários da empresa podem definir as funcionalidades do Copilot para serem ativadas ou desativadas para todas as organizações da empresa que tenham acesso ao Copilot. Em alternativa, podem permitir que cada organização defina a sua própria política para cada recurso.
- Se o proprietário da empresa o tiver permitido, os proprietários da organização poderão ativar ou desativar as funcionalidades do Copilot para a sua organização.

Clique em "Seguinte" no canto inferior direito para iniciar o laboratório.
